...
def create_starting_node_tree(obj, coll_frames, starting_style = "atoms", starting_color = 'random'):
    ...
    if starting_color == 'random':

        link(node_random_colour.outputs['Value'], node_colour.inputs['Nitrogen'])
        link(node_random_colour.outputs['Value'], node_colour.inputs['Oxygen'])
        link(node_random_colour.outputs['Value'], node_colour.inputs['Hydrogen'])
        link(node_random_colour.outputs['Value'], node_colour.inputs['Sulfur'])
        link(node_random_colour.outputs['Value'], node_colour.inputs['Phosphorous'])
        node_random_colour.inputs['Seed'].default_value = int(id(obj) % 10000)
